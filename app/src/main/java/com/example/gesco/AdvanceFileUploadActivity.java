...
public class AdvanceFileUploadActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uploadbymyfamilydoctor);
        ...
        select_all_file.setOnClickListener(AdvanceFileUploadActivity.this);
        gallery_file.setOnClickListener(AdvanceFileUploadActivity.this);
        camera_file.setOnClickListener(AdvanceFileUploadActivity.this);
        submit.setOnClickListener(AdvanceFileUploadActivity.this);

        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (gallery_file_path == null) {
                    Toast.makeText(AdvanceFileUploadActivity.this, "Gallery File Empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (all_file_path == null) {
                    Toast.makeText(AdvanceFileUploadActivity.this, "ALl File File Empty", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (camer_file_path == null) {
                    Toast.makeText(AdvanceFileUploadActivity.this, "CAmera File Empty", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private boolean checkPermission(String permission) {
        int result = ContextCompat.checkSelfPermission(AdvanceFileUploadActivity.this, permission);
    ...
    private void requestPermission(String permission) {
        if (ActivityCompat.shouldShowRequestPermissionRationale(AdvanceFileUploadActivity.this, permission)) {
            Toast.makeText(AdvanceFileUploadActivity.this, "Please Allow Permission", Toast.LENGTH_SHORT).show();
        } else {
            ActivityCompat.requestPermissions(AdvanceFileUploadActivity.this, new String[]{permission}, PERMISSION_REQUEST_CODE);
        }
    }
        ...
        switch (requestCode) {
            case PERMISSION_REQUEST_CODE:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(AdvanceFileUploadActivity.this, "Permission Successfull", Toast.LENGTH_SHORT).show();
                    filePicker(method);
                } else {
                    Toast.makeText(AdvanceFileUploadActivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                }
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                String selectedPath = FilePath.getFilePath(AdvanceFileUploadActivity.this, uri);
            ...
            if (requestCode == ALL_FILE_REQUEST) {
                ...
                Uri uri = data.getData();
                String paths = FilePath.getFilePath(AdvanceFileUploadActivity.this, uri);
...
//    Now Lets Upload it First Create a Server Code for hadnling file
    ...
    public class UploadTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(s!=null){
                Toast.makeText(AdvanceFileUploadActivity.this, "File Uploaded", Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(AdvanceFileUploadActivity.this, "File Upload Failed", Toast.LENGTH_SHORT).show();
            }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url("https://gesco-backend.herokuapp.com/")
                        .post(requestBody)
                        .build();
